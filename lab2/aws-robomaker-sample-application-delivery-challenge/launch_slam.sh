...
S3_BUCKET="deliverychallengevocstar-robomakerdeliverychallen-18qis0i4vzf2t"
ROLE_ARN="arn:aws:iam::773769896243:role/delivery-challenge-simulation-role-us-east-1"
SUBNET='["subnet-dbc085bd", "subnet-27adb86a", "subnet-81e56db0", "subnet-f44c0fd5", "subnet-0ea99600", "subnet-2fd89e70"]' # example  '["subnet-1303f974", "subnet-939d74da", "subnet-d7063791"]'
SECURITY_GROUP='["sg-b7f77ab1"]' # example '["sg-012ffd67"]'
...
SIMULATION_APPNAME="deliverychallenge_sumulation_user1472130-rrezinkin-myseneca-ca"
SIM_APP_PACKAGE="delivery_challenge_simulation"
SIM_APP_LAUNCH_FILE="create_stage0.launch"
SIM_APP_ENV="{\"TURTLEBOT3_MODEL\": \"burger\"}"

ROBOT_APPNAME="deliverychallenge_robot_user1472130-rrezinkin-myseneca-ca"
