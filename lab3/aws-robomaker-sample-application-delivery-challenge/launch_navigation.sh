...
S3_BUCKET="deliverychallengevocstar-robomakerdeliverychallen-1vkawyzgxwwtl"
ROLE_ARN="arn:aws:iam::796893363085:role/delivery-challenge-simulation-role-us-east-1"
SUBNET='["subnet-6f1e6509", "subnet-afc6489e", "subnet-abdb9d8a", "subnet-17f3ce19", "subnet-f83e7aa7", "subnet-fd0a01b0"]' # example  '["subnet-1303f974", "subnet-939d74da", "subnet-d7063791"]'
SECURITY_GROUP='["sg-1a3a5e1d"]' # example '["sg-012ffd67"]'
...
SIMULATION_APPNAME="deliverychallenge_sumulation_user1453981-mschumacher-myseneca-ca"
SIM_APP_PACKAGE="delivery_challenge_simulation"
SIM_APP_LAUNCH_FILE="create_stage.launch"
SIM_APP_ENV="{\"TURTLEBOT3_MODEL\": \"burger\"}"

ROBOT_APPNAME="deliverychallenge_robot_user1453981-mschumacher-myseneca-ca"
